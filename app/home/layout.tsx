...
export default function layout({ children }: { children: React.ReactNode }) {
    ...
    const menuItems: MenuItem[] = [
        { text: '首页', path: '/home', icon: <HomeIcon className="w-5 h-5" /> },
        { text: '电影', path: '/home/movies', icon: <FilmIcon className="w-5 h-5" /> },
        { text: '电视剧', path: '/home/tv', icon: <TvIcon className="w-5 h-5" /> },
        { text: '演员', path: '/home/people', icon: <UserIcon className="w-5 h-5" /> },
        { text: '搜索', path: '/home/search', icon: <MagnifyingGlassIcon className="w-5 h-5" /> },
        { text: '收藏', path: '/home/favorites', icon: <HeartIcon className="w-5 h-5" /> },
    ];
