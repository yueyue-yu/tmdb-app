...
import type { PersonDetailActionsProps } from '@/app/type/personDetail';

export default function PersonDetailActions({ personId, personName }: PersonDetailActionsProps) {
  ...
  const handleBack = () => {
    smartNavigateBack(router, PageType.PERSON_DETAIL);
  };
  ...
  const handleLike = () => {
    setIsLiked(!isLiked);
    // TODO: 实现喜欢功能的 API 调用
    console.log('切换喜欢状态:', personId);
  };

  const handleBookmark = () => {
    setIsBookmarked(!isBookmarked);
    // TODO: 实现收藏功能的 API 调用
    console.log('切换收藏状态:', personId);
  };
