...
import type { MovieDetailActionsProps } from '@/app/type/movieDetail';
import TrailerButton from '../video/TrailerButton';

export default function MovieDetailActions({ movieId, title }: MovieDetailActionsProps) {
  ...
  const handleBack = () => {
    smartNavigateBack(router, PageType.MOVIE_DETAIL);
  };
